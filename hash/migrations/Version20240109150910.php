...
final class Version20240109150910 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__avato_requests AS SELECT id, request_number, input_string, key_found, hash, attempts, moment_request FROM avato_requests');
        ...
        $this->addSql('INSERT INTO avato_requests (id, request_number, input_string, key_found, hash, attempts, moment_request) SELECT id, request_number, input_string, key_found, hash, attempts, moment_request FROM __temp__avato_requests');
